...
trait Pages extends BaseRequests {
  ...
  object ImportVATUnderpaymentConfirmPage extends Page("/disclosure/confirm-import-vat-underpayment-details", "Confirm Import VAT Underpayment")
  object CustomsDutyUnderpaymentConfirmPage extends Page("/disclosure/confirm-customs-duty-underpayment-details", "Confirm Customs Duty Underpayment")
  object ExciseDutyUnderpaymentConfirmPage extends Page("/disclosure/confirm-excise-duty-underpayment-details", "Confirm Excise Duty Underpayment")
  object AdditionalDutyUnderpaymentConfirmPage extends Page("/disclosure/confirm-additional-duty-underpayment-details", "Confirm Additional Duty Underpayment")
  object DefinitiveDumpingDutyUnderpaymentConfirmPage extends Page("/disclosure/confirm-definitive-add-underpayment-details", "Confirm Definitive Dumping Duty Underpayment")
  object ProvisionalDumpingDutyUnderpaymentConfirmPage extends Page("/disclosure/confirm-provisional-add-underpayment-details", "Confirm Provisional Dumping Duty Underpayment")
  object DefinitiveCountervailingDutyUnderpaymentConfirmPage extends Page("/disclosure/confirm-definitive-countervailing-duty-underpayment-details", "Confirm Definitive Countervailing Duty Underpayment")
  object ProvisionalCountervailingDutyUnderpaymentConfirmPage extends Page("/disclosure/confirm-provisional-countervailing-duty-underpayment-details", "Confirm Provisional Countervailing Duty Underpayment")
  object AgriculturalProductsUnderpaymentConfirmPage extends Page("/disclosure/confirm-customs-duty-agricultural-products-underpayment-details", "Confirm Agricultural Products Underpayment")
  object CompensatoryDutyUnderpaymentConfirmPage extends Page("/disclosure/confirm-compensatory-duty-underpayment-details", "Confirm Compensatory Duty Underpayment")
